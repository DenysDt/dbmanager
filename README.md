...
have any built in protection from SQL injection and until I add it myself it's not safe to use even as a joke or a test
_(little local programs should be more than just fine tho)_
